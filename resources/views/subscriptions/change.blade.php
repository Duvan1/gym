     ...
     <div class="col-md-12">
      <div class="panel no-border">
        <div class="panel-title">
          <div class="panel-head font-size-20">Introduzca detalles de la subscripción</div>
       </div>
       ...
       <div class="panel-body">
        ...
        <div class="row">
          ...
          <div class="col-sm-3">
            {!! Form::label('end_date_0','Fecha de fin') !!}
          </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-3">
              <div class="form-group plan-id">
                ...
                <select id="plan_0" name="plan[0][id]" class="form-control selectpicker show-tick show-menu-arrow childPlan" data-live-search="true" data-row-id="0">
                  @foreach($plans as $plan)
                  <option value="{{ $plan->id }}"  {{ ($plan->id == $subscription->plan_id ? "selected" : "") }} data-price="{{ $plan->amount }}" data-days="{{ $plan->days }}" data-row-id="0">{{ $plan->plan_display }} </option>
                  @endforeach
                </select>
...
<div class="row">
  <div class="col-md-12">
    <div class="panel no-border">
      <div class="panel-title">
        <div class="panel-head font-size-20">Introduzca detalle de la factura</div>
      </div>
          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <select id="discount_percent" name="discount_percent" class="form-control selectpicker show-tick show-menu-arrow">
                ...
                @endforeach
                <option value="custom" {{ ($subscription->invoice->discount_percent == "custom" ? "selected" : "") }}>Custom(Rs.)</option>
              </select>
            </div>
          </div>
          <div class="col-sm-4">
...
<div class="row">
  <div class="col-md-12">
    <div class="panel no-border">
      <div class="panel-title">
        <div class="panel-head font-size-20">Introduzca detalles del pago</div>
      </div>
      ...
      <div class="panel-body">
        <div class="row">
          <div class="col-sm-4">
            <div class="form-group">
              {!! Form::label('previous_payment','Pagado') !!}
              <div class="input-group">
                <div class="input-group-addon"><i class="fa fa-inr"></i></div>
...
<div class="row">
  <div class="col-sm-2 pull-right">
    <div class="form-group">
     {!! Form::submit('Cambiar', ['class' => 'btn btn-primary pull-right']) !!}
   </div>
 </div>
</div>
