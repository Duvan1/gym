...
<div class="rightside bg-grey-100">
  <div class="container-fluid">
    ...
    <div class="alert alert-danger">
      ...
      <strong>Whoops!</strong> Hubo un error con su entrada.<br><br>
      <ul>
      ...
      <div class="col-md-12">   
        <div class="panel no-border">
          <div class="panel-title">
            <div class="panel-head font-size-20">Ingrese los detalles de la subscripción</div>
          </div>
   ...
   <div class="row">
    <div class="col-md-12">
      <div class="panel no-border">
        <div class="panel-title">
          <div class="panel-head font-size-20">Introduzca detalles de la factura</div>
        </div>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                      <div class="form-group">
                                        ...
                                        {!! Form::select('mode',array('1' => 'Efectivo', '0' => 'Cheque'),1,['class'=>'form-control selectpicker show-tick', 'id' => 'mode']) !!}      
                                      </div>
                                    </div>
                                    ...
                                    <div id="chequeDetails">
                                      <div class="col-sm-6">
                                        <div class="form-group">
                                          {!! Form::label('number','Numero del Cheque') !!}
