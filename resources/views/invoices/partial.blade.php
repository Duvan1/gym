      ...
      <div class="row"><!-- Main row -->
        <div class="col-lg-12"><!-- Main Col -->
                ...
                <div class="row"> 
                  <div class="col-sm-12 no-padding">
                   ...
                   <div class="col-sm-2">                                        
                    ...
                    {!! Form::select('sort_field',array('created_at' => 'Fecha','invoice_number' => 'Numero de factura','member_name' => 'Nombre del miembro ','total' => 'Cantidad Total','pending_amount' => 'Cantidad Pendiente'),old('sort_field'),['class' => 'form-control selectpicker show-tick show-menu-arrow', 'id' => 'sort_field']) !!}
                  </div>
          ...
          <div class="panel-body bg-white">
           @if($invoices->count() == 0)
           <h4 class="text-center padding-top-15">No se encontraron resultados</h4>
           @else
           ...
           <table id="invoices" class="table table-bordered table-striped">
            ...
            <tbody>              
              ...
              <tr>
                ...
                <td><a href="{{ action('MembersController@show',['id' => $invoice->member->id]) }}">{{ $invoice->member->name}}</a></td>
                <td>{{ $invoice->total}}</td>
