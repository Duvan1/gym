			...
			<div class="col-lg-12"> <!-- Main column -->
				<div class="panel"> <!-- Main Panel-->
						...
						<div class="row"> <!-- Inner row -->
							<div class="col-xs-6"> <!--Left Side Details -->
								<address>
									...
									<strong>Modo(s) de pago</strong><br>
									<?php  
									$modes = array(); 
							...
							<div class="col-xs-6 text-right"> <!--Right Side Details -->
								<address>
									<strong>Dirección del Gimansio</strong><br>
									...
									el {{ $invoice->subscription->start_date->diffInDays($invoice->subscription->end_date) }} días en {{ $invoice->subscription->end_date->toFormattedDateString() }}<br>
								</address>
							</div>
						</div>		<!-- / inner row -->
						...
						<div class="bg-amber-50 padding-md margin-bottom-20 margin-top-20" id="invoiceBlock">
							...
							<div class="table-responsive">
								<table class="table">
									<thead>
										<tr>
											<td><strong>Nombre del articulo</strong></td>
					...
					<div class="panel-footer bg-white no-padding-top padding-bottom-20 hidden-print">
						...
						<a class="btn btn-success pull-right" href="{{ action('InvoicesController@createPayment',['id' => $invoice->id]) }}"><i class="ion-card margin-right-5"></i> Aceptar pago</a>  
						@endpermission
						@endif
						@permission(['manage-gymie','manage-invoices','print-invoice'])
						<button class="btn btn-primary pull-right margin-right-10" onclick="window.print();"><i class="ion-printer margin-right-5"></i> Imprimir</button>
						@endpermission
					</div> <!-- / Footer buttons -->
