...
<div class="rightside bg-grey-100">
  ...
  <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
    ...
    <h1 class="page-title no-line-height">Facturas
      <small>Detalles de todas las facturas</small></h1>
      @permission(['manage-gymie','pagehead-stats'])
      <h1 class="font-size-30 text-right color-blue-grey-600 animated fadeInDown total-count pull-right"><span  data-toggle="counter" data-start="0" data-from="0" data-to="{{ $count }}" data-speed="600" data-refresh-interval="10"></span> <small class="color-blue-grey-600 display-block margin-top-5 font-size-14">Total</small></h1>
      @endpermission
    </div><!-- / PageHead -->
                ...
                <div class="row"> 
                  <div class="col-sm-12 no-padding">
                    ...
                    <div class="col-sm-3">
                      ...
                      <div id="invoice-daterangepicker" class="gymie-daterangepicker btn bg-grey-50 daterange-padding no-border color-grey-600 hidden-xs no-shadow">
                   ...
                   <div class="col-sm-2">                                        
                    ...
                    {!! Form::select('sort_field',array('created_at' => 'Fecha','invoice_number' => 'Numero de factura','member_name' => 'Codigo de miembro','total' => 'Total amount','pending_amount' => 'Cantidad pendiente'),old('sort_field'),['class' => 'form-control selectpicker show-tick show-menu-arrow', 'id' => 'sort_field']) !!}
                  </div>
            ...
            <table id="invoices" class="table table-bordered table-striped">
              ...
              <tbody>              
                ...
                <tr>
                  ...
                  <td><a href="{{ action('MembersController@show',['id' => $invoice->member->id]) }}">{{ $invoice->member_name}}</a></td>
                  <td>{{ $invoice->total}}</td>
                  <td>{{ $invoice->pending_amount}}</td>                    
                  <td>{{ $invoice->discount_amount}}</td>
                  <td><span class="{{ Utilities::getInvoiceLabel ($invoice->status) }}">{{ Utilities::getInvoiceStatus ($invoice->status) }}</span></td>
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        ...
                        <li>
                          ...
                          <a href="#" class="delete-record" data-delete-url="{{ url('invoices/'.$invoice->id.'/delete') }}" data-record-id="{{$invoice->id}}">
                            Delete invoice
                          </a>
                          @endpermission
                        </li>
