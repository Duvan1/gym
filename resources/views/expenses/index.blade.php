...
<div class="rightside bg-grey-100">
  ...
  <div class="page-head bg-grey-100 padding-top-15 no-padding-bottom">
    ...
    <h1 class="page-title no-line-height">Gastos
      ...
      <small>Detalles de todos los gastos</small></h1>
                ...
                <div class="row"> 
                  <div class="col-sm-12 no-padding">
                    ...
                    <div class="col-sm-3">
                      ...
                      <div id="expense-daterangepicker" class="gymie-daterangepicker btn bg-grey-50 daterange-padding no-border color-grey-600 hidden-xs no-shadow">
                  ...
                  <div class="col-sm-2">                                        
                    ...
                    {!! Form::select('sort_field',array('created_at' => 'Fecha','name' => 'Nombre','amount' => 'Cantidad','due_date' => 'Fecha de vencimiento','category_name' => 'Categoria'),old('sort_field'),['class' => 'form-control selectpicker show-tick show-menu-arrow', 'id' => 'sort_field']) !!}
                  </div>
              ...
              <table id="expenses" class="table table-bordered table-striped">             
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center"><span class="{{ Utilities::getPaidUnpaid ($expense->paid) }}">{{ Utilities::getInvoiceStatus ($expense->paid) }}</td>
                      <td class="text-center">
                        ...
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu" role="menu">
                            ...
                            <li>
                              <a href="#" class="delete-record" data-delete-url="{{ url('expenses/'.$expense->id.'/delete') }}" data-record-id="{{$expense->id}}">
                                Delete expense                                            
                              </a>
                            </li>
                            @endpermission
