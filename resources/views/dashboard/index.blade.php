			...
			<div class="panel bg-light-blue-400">
				<div class="panel-body padding-15-20">
					<div class="clearfix">
						...
						<div class="pull-left">
							<div class="display-block color-light-blue-50 font-weight-600">Total de miembros</div>
						</div>
					</div>
				</div>
			</div><!-- /.panel -->
			...
			<div class="panel bg-grey-500">
				<div class="panel-body padding-15-20">
					<div class="clearfix">
						...
						<div class="pull-left">
							<div class="display-block color-grey-50 font-weight-600">Membresia vencida</div>
						</div>
					</div>
				</div>
			</div><!-- /.panel -->
		...
		<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
			<div class="panel bg-green-400">
				<div class="panel-body padding-15-20">
					<div class="clearfix">
						<div class="pull-left">
							<div class="color-white font-size-24 font-roboto font-weight-600" data-toggle="counter" data-start="0" data-from="0" data-to="{{ App\Payment_detail::whereMonth('created_at','=',Carbon::today()->month)->sum('payment_amount') }}" data-speed="500" data-refresh-interval="10"></div>
						</div>
						<div class="pull-right">
		...
		<div class="col-lg-6">
			<div class="panel">
				<div class="panel-title">
					...
					<div class="pull-right"><a href="{{ action('MembersController@create') }}" class="btn-sm btn-primary active" role="button"><i class="fa fa-user-plus"></i> Agregar</a></div>
				</div>

				<div class="panel-body with-nav-tabs">
					<!-- Tabs Heads -->
					<ul class="nav nav-tabs">
						<li class="active"><a href="#expiring" data-toggle="tab">Por vencerse<span class="label label-warning margin-left-5">{{ $expiringCount }}</span></a></li>
						<li><a href="#expired" data-toggle="tab">Vencido<span class="label label-danger margin-left-5">{{ $expiredCount }}</span></a></li>
					...
					<div class="tab-content">
						<div class="tab-pane fade in active" id="expiring">
							<div class="table-responsive <?php echo (!$expirings->isEmpty() ? "panel-scroll" : "") ?>">
								<table class="table table-hover table-condensed">
									...
									<tr>
										...
										<td>
											<a class="btn btn-info btn-xs btn pull-right" href="{{ action('SubscriptionsController@renew',['id' => $expiring->invoice_id]) }}">Renovar</a>
										</td>
										@endpermission
									</tr>
									@empty
							...
							<a class="btn btn-color btn-xs palette-concrete pull-right margin-right-10 margin-top-10" href="{{ action('SubscriptionsController@expiring') }}">Ver todos</a>
							@endif
						</div>
							...
							<table class="table table-hover">
								...
								<tr>
									...
									<td>
										...
										@permission(['manage-gymie','manage-subscriptions','renew-subscription'])
										<a class="btn btn-xs btn-info pull-right" href="{{ action('SubscriptionsController@renew',['id' => $expired->invoice_id]) }}">Renovar</a>
										@endpermission
										{!! Form::Close() !!}
									</td>
								</tr>
						...
						<a class="btn btn-color btn-xs palette-concrete pull-right margin-right-10 margin-top-10" href="{{ action('SubscriptionsController@expired') }}">Ver todos</a>
						@endif
					</div>
					...
					<div class="tab-pane fade" id="recent">
						...
						@if(!$recents->isEmpty())
						<a class="btn btn-color btn-xs palette-concrete pull-right margin-right-10 margin-top-10" href="{{ action('MembersController@index') }}">Ver todos</a>
						@endif
					</div>
				</div>
			</div>
	...
	<div class="col-lg-6">
		<div class="panel">
			<div class="panel-title">
				...
				<div class="pull-right"><a href="{{ action('EnquiriesController@create') }}" class="btn-sm btn-primary active" role="button"><i class="fa fa-phone"></i> Agregar</a></div>
			</div>
			...
			<div class="panel-body with-nav-tabs">
				...
				<ul class="nav nav-tabs">
					...
					<li><a href="#reminders" data-toggle="tab">Recordatorios<span class="label label-warning margin-left-5">{{ $reminderCount }}</span></a></li>
				</ul>
				...
				<div class="tab-content">
					<div class="tab-pane fade in active" id="enquiries">
						...
						<a class="btn btn-color btn-xs palette-concrete pull-right margin-right-10 margin-top-10" href="{{ action('EnquiriesController@index') }}">Ver todas</a>
						@endif
					</div>
...
<div class="row">
	...
	<div class="col-lg-6">
		<div class="panel">
			<div class="panel-title">
				<div class="panel-head"><i class="fa fa-inr"></i><a href="{{ action('ExpensesController@index') }}">Gastos</a></div>
				<div class="pull-right"><a href="{{ action('ExpensesController@create') }}" class="btn-sm btn-primary active" role="button"><i class="fa fa-inr"></i> Agregar</a></div>
			</div>

			<div class="panel-body with-nav-tabs">
				<!-- Tabs Heads -->
				<ul class="nav nav-tabs">
					<li class="active"><a href="#due" data-toggle="tab">Se debe</a></li>
						...
						<div class="table-responsive <?php echo (!$dues->isEmpty() ? "panel-scroll" : "") ?>">
							<table class="table table-hover table-condensed">
								...
								<tr>
									...
									<td><a class="btn btn-info btn-xs btn pull-right" href="{{ action('ExpensesController@paid',['id' => $due->id]) }}">Pagar</a></td>
								</tr>
								@empty
								<div class="tab-empty-panel font-size-24 color-grey-300">
									Sin datos
	...
	<div class="col-lg-6">
		<div class="panel">
			...
			<div class="panel-body with-nav-tabs">
				<!-- Tabs Heads -->
				<ul class="nav nav-tabs">
					<li class="active"><a href="#recieved" data-toggle="tab">Recibidos<span class="label label-warning margin-left-5">{{ $recievedChequesCount }}</span></a></li>
					<li><a href="#deposited" data-toggle="tab">Depositados<span class="label label-primary margin-left-5">{{ $depositedChequesCount }}</span></a></li>
					<li><a href="#bounced" data-toggle="tab">Rebotados<span class="label label-danger margin-left-5">{{ $bouncedChequesCount }}</span></a></li>
				</ul>
						...
						<div class="table-responsive <?php echo (!$recievedCheques->isEmpty() ? "panel-scroll" : "") ?>">
							<table class="table table-hover table-condensed">
								...
								<tr>
									...
									<td><a class="btn btn-info btn-xs btn pull-right" href="{{ action('PaymentsController@depositCheque',['id' => $recievedCheque->payment_id]) }}">Marcar como depositado</a></td>
								</tr>
								@empty
								<div class="tab-empty-panel font-size-24 color-grey-300">
									sin datos
						...
						<div class="table-responsive <?php echo (!$depositedCheques->isEmpty() ? "panel-scroll" : "") ?>">
							<table class="table table-hover">
								...
								<tr>
									...
									<td>
										<a href="{{ action('PaymentsController@chequeBounce',['id' => $depositedCheque->payment_id]) }}" class="btn btn-xs btn-danger pull-right margin-left-5">Marcar como rebotado</a>
										<a class="btn btn-xs btn-success pull-right" href="{{ action('PaymentsController@clearCheque',['id' => $depositedCheque->payment_id]) }}">Marcar como despejado</a>
									</td>
								</tr>
								@empty
								<div class="tab-empty-panel font-size-24 color-grey-300">
						...
						<div class="table-responsive <?php echo (!$bouncedCheques->isEmpty() ? "panel-scroll" : "") ?>">
							<table class="table table-hover">
								...
								<tr>
									...
									<td><a class="btn btn-info btn-xs btn pull-right" href="{{ action('PaymentsController@chequeReissue',['id' => $bouncedCheque->payment_id]) }}">Reeditado</a></td>
								</tr>
								@empty
								<div class="tab-empty-panel font-size-24 color-grey-300">
									Sin datos
		...
		<div class="panel">
			...
			<div class="panel-body">
				<div class="row">
						...
						<div class="panel bg-light-blue-400">
							<div class="panel-body padding-15-20">
								<div class="clearfix">
									...
									<div class="pull-left">
										<div class="display-block color-light-blue-50 font-weight-600">Balance de SMS</div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-7">
						<button class="btn btn-labeled btn-success pull-right margin-top-20" data-toggle="modal" data-target="#smsRequestModal" data-id="smsRequestModal"><span class="btn-label"><i class="glyphicon glyphicon-ok"></i></span>Solicitar mas sms</button>
					</div>
					@endif
				</div>
				...
				@if(!$smslogs->isEmpty())
				<a class="btn btn-color btn-xs palette-concrete pull-right margin-right-10 margin-top-10" href="{{ action('SmsController@logIndex') }}">Ver todo</a>
				@endif
			</div>
		</div>
	</div>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Confirma solicitar nuevo paquete de sms</h4>
			</div>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							{!! Form::label('smsCount','Selecciona paquete SMS') !!}
