...
<div class="rightside bg-grey-100">
  ...
  <div class="page-head bg-grey-100">
    ...
    <a href="{{ action('AclController@createPermission') }}" class="btn btn-primary active pull-right" role="button"> Agregar</a></h1> 
  </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                  ...
                  <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal-{{$permission->id}}" data-id="{{$permission->id}}">
