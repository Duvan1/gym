    ...
    <div class="row">
     <div class="col-md-12">
      ...
      <div class="alert alert-danger">
        ...
        <strong>Whoops!</strong> Introduzca los detalles del permiso.<br><br>
        <ul>
      ...
      <div class="panel no-border">
        <div class="panel-title">
          <div class="panel-head">Introduzca detalles del usuario.</div>
        </div>
      ...
      <div class="panel no-border">
        <div class="panel-title">
          <div class="panel-head">Introduzca el rol del usuario.</div>
        </div>
        <div class="panel-body">
          <div class="row">
            <div class="col-sm-6">
