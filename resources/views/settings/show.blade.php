				...
				<div class="panel no-border">
					...
					<div class="panel-body"> <!-- Panel Body -->
						...
						<div class="row"> <!-- First Row -->
							...
							<div class="col-sm-4">
								<div class="form-group">
									<label>Inicio del año financiero</label>
							...
							<div class="col-sm-4">
								<div class="form-group">
									<label>Fin del ejercicio financiero</label>
						...
						<div class="row"> <!-- Second row -->
							...
							<div class="col-sm-8">
								<div class="row">
									<div class="col-sm-12">
										<div class="form-group">
											<label>Dirección del gimnasio linea 1</label>
						...
						<div class="row"> 		<!-- Panel Row -->
							<div class="col-sm-12"> <!-- Panel Column -->
								...
								<div class="row">   <!-- Inner row -->
									...
									<div class="col-sm-3">
										<div class="form-group">
											<label>Factura último número</label>
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<div class="row">	 <!-- Inner row -->
									<div class="col-sm-4">
										<div class="form-group">
											<label>Prefijo del codigo</label>
									...
									<div class="col-sm-4">
										<div class="form-group">
											<label>Último numero del codigo</label>
