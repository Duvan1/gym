			...
			<div class="sidebar">
				...
				<ul class="nav-sidebar">
					...
					<li class="nav-dropdown {{ Utilities::setActiveMenu('enquiries*',true) }}">
						...
						<ul>
							<li class="{{ Utilities::setActiveMenu('enquiries/all') }}"><a href="{{ action('EnquiriesController@index') }}">Todas las consultas</a></li>
							@permission(['manage-gymie','manage-enquiries','add-enquiry'])
							<li class="{{ Utilities::setActiveMenu('enquiries/create') }}"><a href="{{ action('EnquiriesController@create') }}">Agregar consulta</a></li>                            
							@endpermission
						</ul>
					</li>
					@endpermission
					...
					<li class="nav-dropdown {{ Utilities::setActiveMenu('members*',true) }}">
						...
						<ul>
							...
							<li class="{{ Utilities::setActiveMenu('members/create') }}"><a href="{{ action('MembersController@create') }}">Agregar miembros</a></li>                            
							@endpermission
							<li class="{{ Utilities::setActiveMenu('members/active') }}"><a href="{{ action('MembersController@active') }}">Miembros activos</a></li>
							<li class="{{ Utilities::setActiveMenu('members/inactive') }}"><a href="{{ action('MembersController@inactive') }}">Miembros inactivos</a></li>                                
						</ul>
					</li>
					@endpermission
					...
					<li class="nav-dropdown {{ Utilities::setActiveMenu('subscriptions*',true) }}">
						...
						<ul>
							...
							<li class="{{ Utilities::setActiveMenu('subscriptions/create') }}"><a href="{{ action('SubscriptionsController@create') }}">Agregar Subscripciones</a></li>
							@endpermission
							<li class="{{ Utilities::setActiveMenu('subscriptions/expiring') }}"><a href="{{ action('SubscriptionsController@expiring') }}">Subscripciones por expirar</a></li>
							<li class="{{ Utilities::setActiveMenu('subscriptions/expired') }}"><a href="{{ action('SubscriptionsController@expired') }}">Subscripciones expiradas</a></li>
						</ul>
					</li>
					@endpermission
					<!-- +++++++++++++++++++++ Reportes ++++++++++++++++++++ -->
					<li class="nav-dropdown {{-- Utilities::setActiveMenu('reports*',true) --}}">
						...
						<ul>
							<li class="{{-- Utilities::setActiveMenu('reports/members/*') --}}"><a href="{{-- action('ReportsController@gymMemberCharts') --}}">Miembros</a></li>
							<li class="{{-- Utilities::setActiveMenu('reports/enquiries/*') --}}"><a href="{{-- action('ReportsController@enquiryCharts') --}}">Consultas</a></li>
							<li class="{{-- Utilities::setActiveMenu('reports/subscriptions/*') --}}"><a href="{{-- action('ReportsController@subscriptionCharts') --}}">Subscripciones</a></li>
							<li class="{{-- Utilities::setActiveMenu('reports/payments/*') --}}"><a href="{{-- action('ReportsController@paymentCharts') --}}">Pagos</a></li>                            
							<li class="{{-- Utilities::setActiveMenu('reports/expenses/*') --}}"><a href="{{-- action('ReportsController@expenseCharts') --}}">Gastos</a></li>                            
							<li class="{{-- Utilities::setActiveMenu('reports/invoices/*') --}}"><a href="{{-- action('ReportsController@invoiceCharts') --}}">Facturas</a></li>                            
						</ul>
					</li> 
					<!-- +++++++++++++++++++++ Reportes ++++++++++++++++++++ -->
					...
					<li class="nav-dropdown {{ Utilities::setActiveMenu('sms*',true) }}">
						...
						<ul>
							<li class="{{ Utilities::setActiveMenu('sms/triggers') }}"><a href="{{ action('SmsController@triggersIndex') }}">Desencadenado</a></li>
							<li class="{{ Utilities::setActiveMenu('sms/events') }}"><a href="{{ action('SmsController@eventsIndex') }}">Mensaje programado</a></li>                            
					...
					<li class="nav-dropdown {{ Utilities::setActiveMenu('invoices*',true) }}">
						...
						<ul>
							...
							<li class="{{ Utilities::setActiveMenu('invoices/unpaid') }}"><a href="{{ action('InvoicesController@unpaid') }}">Facturas sin pagar</a></li>
							<li class="{{ Utilities::setActiveMenu('invoices/partial') }}"><a href="{{ action('InvoicesController@partial') }}">Facturas parciales</a></li>
							<li class="{{ Utilities::setActiveMenu('invoices/overpaid') }}"><a href="{{ action('InvoicesController@overpaid') }}">Facturas sobrepagadas</a></li>
						</ul>
					</li>
					@endpermission
					...
					<li class="nav-dropdown {{ Utilities::setActiveMenu('expenses*',true) }}">
						...
						<ul>
							...
							<li class="{{ Utilities::setActiveMenu('expenses/categories/all') }}"><a href="{{ action('ExpenseCategoriesController@index') }}">Categorias de Gastos</a></li>
							@endpermission
							@permission(['manage-gymie','manage-expenseCategories','add-expenseCategory'])
							<li class="{{ Utilities::setActiveMenu('expenses/categories/create') }}"><a href="{{ action('ExpenseCategoriesController@create') }}">Agregar categoria</a></li>                            
							@endpermission
						</ul>
					</li>
					@endpermission
					...
					<li class="nav-dropdown {{ Utilities::setActiveMenu('plans*',true) }}">
						...
						<ul>
							...
							<li class="{{ Utilities::setActiveMenu('plans/services/all') }}"><a href="{{ action('ServicesController@index') }}">Servicios del Gym</a></li>
							@endpermission
							@permission(['manage-gymie','manage-services','add-service'])
							<li class="{{ Utilities::setActiveMenu('plans/services/create') }}"><a href="{{ action('ServicesController@create') }}">Agregar Servicio</a></li>                            
							@endpermission
						</ul>
					</li>
					@endpermission
					...
					<li class="nav-dropdown {{ Utilities::setActiveMenu('user*',true) }}">
						...
						<ul>
							...
							<li class="{{ Utilities::setActiveMenu('user/create') }}"><a href="{{ action('AclController@createUser') }}"><i class="fa fa-list"></i> Agregar un nuevo usuario</a></li>
							<li class="{{ Utilities::setActiveMenu('user/role') }}"><a href="{{ action('AclController@roleIndex') }}"><i class="fa fa-list"></i> Roles</a></li>
							@role('Gymie')
							<li class="{{ Utilities::setActiveMenu('user/permission') }}"><a href="{{ action('AclController@permissionIndex') }}"><i class="fa fa-list"></i> Permisos</a></li>
							@endrole
						</ul>
					</li>
					@endpermission
