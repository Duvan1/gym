  ...
  public function __construct()
  {
    ...
    public function store(Request $request)
    {
      ...
      try {
        ...
        'shoulder_measurements'=>$request->shoulder_measurements,
        'chest_measurements'=> $request->chest_measurements,
        'arm_measurements'=> $request->arm_measurements,
        'forearm_measurements'=> $request->forearm_measurements,
        'hip_measurements'=>$request->hip_measurements,
        'waist_measurements'=>$request->waist_measurements,
        'thigt_measurements'=>$request->thigt_measurements,
        'calf_measurements'=> $request->calf_measurements,
